...
After calculating Perplexity for the range of topics from 2-45, we can see that 43/44 returns the lowest numbers.  However, this would most likley be at a level of granularity greater than we need. 
