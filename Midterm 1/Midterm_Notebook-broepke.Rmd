...
Two outlier transactions stick out in terms of revenue.  Without removing them, the scatter plot is hard to interpret.  First, let's look at what those transactions are, and second, we can pair down the data a little bit. 
...
Filtering out those larger transactions, we can see a slightly positive correlation of the independent variable `Revenue` to the dependent variable, `Pageviews.`
...
Our continuous variable `pageviews` tells us that for every increase in of 1 pageview we have a 0.131% 

**Note**: I'm less familar admitedly how to interpret this. 

https://stats.idre.ucla.edu/r/dae/logit-regression/

**Examine the confidence intervals for the model**
...
The chi-squared test statistic of 176.9 and P-value of 0.0 tells us the test is statistically significant.


## Multiple Regression Model to Predict Transaction Revenue

Using a multiple regression model to predict the independent variable revenue from other dependent variables.
