...
As suspected, The top 10 tweets show US based locations (`Earth` being an exception). Position 11 shows `Melbourne` as the location.  Which could be either Australia or Florida, which has the same spelling as the Australian city.  Of course, this is to be expected because it's a US election, however, the US does effect the global economy so it tends to be watched by many people around the world.
...
This is super boring.  It's a bot that's retweeting Twitter Follower's Stats. 
